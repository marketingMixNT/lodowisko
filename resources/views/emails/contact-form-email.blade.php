...
<head>
  ...
  <![endif]-->
    <title>Nowa wiadomość ze strony lodowiskobialka.pl</title>
    <style>
...
<body
    ...
    <div role="article" aria-roledescription="email" aria-label="Nowa wiadomość ze strony lodowiskobialka.pl" lang="pl">
        <div class="sm-px-4"
                            ...
                            <tr>
                                <td class="sm-px-6"
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <a href="mailto:{{ $email }}"
                                                style="color: #f8fafc; background-color: #7c98a5; display: inline-block; border-radius: 4px; padding: 16px 24px; font-size: 16px; line-height: 1; font-weight: 600; text-decoration: none;">
                                                <!--[if mso]>
