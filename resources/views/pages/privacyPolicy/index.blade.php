<x-layouts.app title="Polityka Prywatności – Lodowisko Biała Owca w Białce Tatrzańskiej"
    ...
    <div class="flex flex-col justify-center items-center mx-auto text-center  max-w-screen-xl gap-16 2xl:gap-32 pb-20">
        ...
        <div class="flex flex-col gap-6 sm:gap-12 mt-32 lg:mt-24 xl:mt-36 2xl:mt-0 px-10 sm:px-0">
            ...
            <h1 class="text-5xl sm:text-6xl 2xl:text-8xl font-heading pt-12" style="line-height: 1.2">Polityka Prywatności </h1>
...
<x-section id="polityka-prywatnosci">
    <div class="flex flex-col max-w-screen-lg mx-auto py-24  prose ">
        ...
        <p>Opisuje zasady przetwarzania przez nas informacji na Twój temat, w tym danych osobowych oraz ciasteczek, czyli tzw. cookies.</p>
        
        <h2>1. Informacje ogólne</h2>
        <p>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <strong>lodowiskobialka.pl</strong></p>
        <p>Operatorem serwisu oraz Administratorem danych osobowych jest: <strong>Lodowisko Owce Dwie Środkowa 161, Białka Tatrzańska</strong></p>
        ...
        <h2>3. Hosting</h2>
        <p>Serwis jest hostowany (technicznie utrzymywany) na serwerach operatora: <strong>cyberFolks.pl</strong></p>
...
<p>Operator stosuje analizę statystyczną ruchu na stronie, poprzez Google Analytics (Google Inc. z siedzibą w USA). Operator nie przekazuje do operatora tej usługi danych osobowych, a jedynie zanonimizowane informacje. Usługa bazuje na wykorzystaniu ciasteczek w urządzeniu końcowym użytkownika. W zakresie informacji o preferencjach użytkownika gromadzonych przez sieć reklamową Google użytkownik może przeglądać i edytować informacje wynikające z plików cookies za pomocą narzędzia: <a href="https://www.google.com/ads/preferences/">https://www.google.com/ads/preferences/</a>.</p>
<p>Operator stosuje techniki remarketingowe, pozwalające na dopasowanie przekazów reklamowych do zachowania użytkownika na stronie, co może dawać złudzenie, że dane osobowe użytkownika są wykorzystywane do jego śledzenia, jednak w praktyce żadne dane osobowe nie są przekazywane od Operatora do operatorów reklam. Technologicznym warunkiem takich działań jest włączona obsługa plików cookie.</p>
<p>Operator stosuje wykorzystanie piksela Facebooka. Technologia ta powoduje, że serwis Facebook (Meta Platforms Inc., USA) wie, że dana osoba zarejestrowana w nim korzysta z Serwisu. W tym przypadku opiera się na danych, wobec których sam jest administratorem, Operator nie przekazuje dodatkowych danych osobowych od siebie do serwisu Facebook. Usługa bazuje na wykorzystaniu ciasteczek w urządzeniu końcowym użytkownika.</p>
<p>Operator stosuje rozwiązanie automatyzujące działanie Serwisu w odniesieniu do użytkowników, np. mogące przesłać e-mail do użytkownika po odwiedzeniu konkretnej podstrony, o ile użytkownik wyraził zgodę na otrzymywanie korespondencji handlowej od Operatora.</p>
...
<p>Pliki cookies zamieszczane w urządzeniu końcowym Użytkownika Serwisu wykorzystywane mogą być również przez współpracujące z operatorem Serwisu podmioty, w szczególności dotyczy to firm: Google (Google Inc. z siedzibą w USA), Facebook (Meta Platforms Inc., USA).</p>
...
<ul>
    ...
    <li><a href="https://support.mozilla.org/pl/kb/wlaczanie-i-wylaczanie-ciasteczek-w-serwisach-firefox">Firefox</a></li>
